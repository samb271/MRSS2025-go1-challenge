...
"""
Configuration for the locomotion velocity-tracking environment with Unitree Go1 robot.
"""
...
class Go1LocomotionEnvCfg(ManagerBasedRLEnvCfg):
    ...
    def __post_init__(self):
        ...
        if getattr(self.scene.terrain, "terrain_generator", None) is not None:
            if isinstance(self.scene.terrain.terrain_generator, TerrainGeneratorCfg):
