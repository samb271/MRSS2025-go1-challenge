...
if args_cli.config:
    ...
    # separate CLI arguments from Hydra overrides
    ...
    # add headless to hydra_args if specified in config
    # if "headless" in cli_params and cli_params["headless"]:
    #     hydra_args.append("--headless")
